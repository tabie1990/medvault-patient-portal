...
const STRINGS = {
  ...
  packagesHeadline: { en: 'Health check-up packages', fr: 'Forfaits de bilan de santé' },
  perChild: { en: 'per child', fr: 'par enfant' },
  homeServiceFeeNote: { en: 'for a home visit', fr: 'pour une visite à domicile' },
  bookThisPackage: { en: 'Book this package', fr: 'Réserver ce forfait' },
  packageFormIncomplete: {
    en: 'Please fill in the city, phone number, and a valid age for every child.',
    fr: "Veuillez indiquer la ville, le numéro de téléphone et un âge valide pour chaque enfant."
  },
  numberOfChildren: { en: 'Number of children', fr: "Nombre d'enfants" },
  childAgeLabel: { en: "Child's age", fr: "Âge de l'enfant" },
  homeServiceLabel: { en: 'Home visit (we come to you)', fr: 'Visite à domicile (nous venons chez vous)' },
  preferredDateLabel: { en: 'Preferred date (optional)', fr: 'Date préférée (facultatif)' },
  preferredTimeRangeLabel: { en: 'Preferred time (optional)', fr: 'Heure préférée (facultatif)' },
  noPreference: { en: 'No preference', fr: 'Aucune préférence' },
  morning: { en: 'Morning', fr: 'Matin' },
  afternoon: { en: 'Afternoon', fr: 'Après-midi' },
  evening: { en: 'Evening', fr: 'Soir' },
  guardianNameLabel: { en: 'Your name (optional)', fr: 'Votre nom (facultatif)' },
  guardianPhoneLabel: { en: 'Your phone number', fr: 'Votre numéro de téléphone' },
  confirmBooking: { en: 'Confirm booking', fr: 'Confirmer la réservation' },
  bookingRefLabel: { en: 'Booking reference', fr: 'Référence de réservation' },
  trackYourBookingTitle: { en: 'Track your booking', fr: 'Suivre votre réservation' },
  bookingRefPlaceholder: { en: 'e.g. MVP-1234567890-ABCDEF', fr: 'ex. MVP-1234567890-ABCDEF' },
  bookingNotFound: { en: 'No booking found with that reference.', fr: 'Aucune réservation trouvée avec cette référence.' },
  yes: { en: 'Yes', fr: 'Oui' },
  no: { en: 'No', fr: 'Non' },
  priceLabel: { en: 'Price', fr: 'Prix' },
  bookedOnLabel: { en: 'Booked on', fr: 'Réservé le' },
  ourPartners: { en: 'Our partner hospitals & clinics', fr: 'Nos hôpitaux et cliniques partenaires' },
